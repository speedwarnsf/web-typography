 ...
 */
export declare function TypesetText({ text, as, mode, keep, maxLines, density, lineBreaks, smartQuotes, opticalHanging, spacing, contour, ...attributes }: TypesetTextProps): import("react").DetailedReactHTMLElement<{
