...
balance cannot override chosen breaks. Ordinary wrapping and post-render
verification remain enabled. Teardown restores the authored wrapping policy
without discarding unrelated client style updates.
