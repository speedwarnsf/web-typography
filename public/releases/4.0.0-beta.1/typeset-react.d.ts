 ...
 */
export declare function TypesetText({ text, as, mode, keep, maxLines, density, lineBreaks, smartQuotes, opticalHanging, ...attributes }: TypesetTextProps): import("react").DetailedReactHTMLElement<{
