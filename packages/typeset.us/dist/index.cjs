/* typeset.us v3.0.0 — MIT © Dustin York. https://typeset.us */
"use strict";
...
// src/lib/typeset.core.ts
var typeset_core_exports = {};
__export(typeset_core_exports, {
  audit: () => audit,
  ...
  tokenize: () => tokenize,
  typeset: () => typeset,
  typesetAll: () => typesetAll,
  typesetHeading: () => typesetHeading,
  typesetText: () => typesetText
});
module.exports = __toCommonJS(typeset_core_exports);
