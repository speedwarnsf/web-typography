...
const options = { smartQuotes: script?.dataset.typesetSmartQuotes === 'en' ? 'en' as const : false as const, opticalHanging: script?.dataset.typesetOpticalHanging === 'true', spacing: script?.dataset.typesetSpacing !== 'false' };
window.Typeset = api;
