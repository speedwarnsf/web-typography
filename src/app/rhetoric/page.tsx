...
const fonts: RhetoricalFont[] = [
  ...
  {
    name: "Bitter",
    variable: "var(--font-bitter)",
    ethos: 45,
    pathos: 30,
    logos: 70,
    tags: ["slab", "sturdy", "warm-mechanical", "grounded"],
    bestFor: "The friendly machine: slab warmth bolted onto a grid. Product docs that want to feel dependable rather than cold.",
  },
  {
    name: "Spectral",
    variable: "var(--font-spectral)",
    ethos: 65,
    pathos: 38,
    logos: 55,
    tags: ["literary", "screen-native", "considered", "editorial"],
    bestFor: "A literary serif engineered for screens — bookish credibility that survives a phone. Essays, longform, serious blogs.",
  },
  {
    name: "Work Sans",
    variable: "var(--font-work-sans)",
    ethos: 35,
    pathos: 15,
    logos: 80,
    tags: ["plain", "workhorse", "unassuming", "utilitarian"],
    bestFor: "The plain workhorse: says nothing so the content says everything. Forms, documentation, interfaces that should disappear.",
  },
  {
...
export default function RhetoricPage() {
  ...
  return (
    <main className="min-h-screen text-neutral-200 overflow-x-hidden" style={{ backgroundColor: '#0a0a0a' }}>
