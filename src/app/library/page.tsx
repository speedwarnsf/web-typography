...
export const metadata = {
  title: "The Library — Rules, Pairings & Tips — Typeset.us",
  description:
    "The working reference: typographic rules, 40 curated font pairings, and practical tips — every paragraph set live by the Typeset engine.",
};
    ...
    <main className="min-h-screen relative" style={{ zIndex: 2 }}>
      ...
      <section className="relative flex flex-col justify-center min-h-[78vh] px-6 sm:px-8 pt-28 pb-16 max-w-5xl mx-auto">
        ...
        <nav className="mt-14 flex flex-wrap gap-x-8 gap-y-5">
          ...
          <a href="/" className="font-mono text-xs uppercase tracking-[0.25em] text-neutral-400 border-b border-neutral-700 pb-1 hover:text-neutral-200 hover:border-neutral-400 transition-colors">Home</a>
        </nav>
      </section>
