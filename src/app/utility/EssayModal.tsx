      ...
      {isOpen && mounted && typeof document !== "undefined" && createPortal(
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 sm:p-6 overflow-y-auto">
          ...
          >
            ...
            <div ref={modalRef} className="py-8 pl-8 pr-4 sm:py-12 sm:pl-12 sm:pr-8 lg:py-16 lg:pl-16 lg:pr-8 max-h-[85vh] overflow-y-auto overscroll-contain">
              ...
              <div className="space-y-12 text-neutral-300 text-base sm:text-lg leading-relaxed" style={{ fontFamily: "var(--font-source-sans)" }}>
                ...
                <section>
                  ...
                  <p className="mb-6">
                    My thesis, written in the final year of my degree, was about the future of typography on the web. In the early 2000s this was a live question. Screens were low-resolution, font rendering was crude, and the tools for typographic control that print had developed over centuries simply did not exist in the browser. I predicted that e-ink would solve the problem. I was wrong about e-ink. But the underlying diagnosis — that web typography was structurally broken, that it lacked the mathematical intelligence to set text the way text deserved to be set — was correct. And it remained correct for thirty years.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="mb-6">
                    I did not <span className="whitespace-nowrap">ask Io</span> to write it. I described what I wanted to say — the lived experience of thirty years of typographic frustration, the intellectual inheritance from NSCAD, the failures of the early implementations, the strangeness and genuine productivity of this collaboration — and worked with Io to find the form that could hold all of it. Io proposed structure, challenged imprecision in my thinking, and produced drafts that I revised through conversation. The result sounds like me because I made sure it did, and is more rigorous than I could have made it alone.
                  </p>
                  <p className="mb-6">
