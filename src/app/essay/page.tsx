...
export const metadata: Metadata = {
  title: "The Invisible Infrastructure — typeset.us",
  description: "A practitioner's account of web typography, thirty years on. By Dustin York & Io.",
};

export default function EssayPage() {
  return (
    <main className="min-h-screen pt-32 pb-24 px-4 sm:px-6 relative" style={{ zIndex: 2 }}>
      <article className="max-w-3xl mx-auto bg-black/80 backdrop-blur-md border border-neutral-800 p-8 sm:p-12 lg:p-16">
        ...
        <header className="mb-16 text-center">
          ...
          <p 
            className="text-lg sm:text-xl text-neutral-400 mb-8 italic"
            style={{ fontFamily: "var(--font-lora, var(--font-playfair))" }}
          >
            A practitioner's account of web typography, thirty years on
          </p>
          
          <div className="flex items-center justify-center gap-3 text-sm font-mono text-neutral-500 uppercase tracking-widest">
          ...
          <div className="mt-8">
            <Link 
              href="/utility"
              className="inline-flex items-center gap-2 px-4 py-2 border border-emerald-900/40 bg-emerald-950/20 text-emerald-400 text-xs font-mono uppercase tracking-widest hover:bg-emerald-950/40 transition-colors"
            >
        ...
        <div className="mb-16 pb-12 border-b border-neutral-800">
          <p className="text-lg sm:text-xl text-neutral-300 leading-relaxed font-medium" style={{ fontFamily: "var(--font-source-sans)" }}>
        ...
        {/* Body */}
        <div className="space-y-16 text-neutral-300 text-lg leading-relaxed" style={{ fontFamily: "var(--font-source-sans)" }}>
          
          <section>
            <p className="font-mono text-[#B8963E] text-sm mb-4">I.</p>
            <h2 className="text-2xl font-bold mb-6 text-neutral-100" style={{ fontFamily: "var(--font-playfair)" }}>The Thesis</h2>
            
            <p className="mb-6">
              <span className="float-left text-5xl sm:text-6xl leading-none font-bold pr-3 pt-2 text-[#B8963E]" style={{ fontFamily: "var(--font-playfair)" }}>T</span>
          ...
          <section>
            <p className="font-mono text-[#B8963E] text-sm mb-4">II.</p>
            <h2 className="text-2xl font-bold mb-6 text-neutral-100" style={{ fontFamily: "var(--font-playfair)" }}>The Problem the Browser Never Solved</h2>
            
            <p className="mb-6">
              <span className="float-left text-5xl sm:text-6xl leading-none font-bold pr-3 pt-2 text-[#B8963E]" style={{ fontFamily: "var(--font-playfair)" }}>I</span>
          ...
          <section>
            <p className="font-mono text-[#B8963E] text-sm mb-4">III.</p>
            <h2 className="text-2xl font-bold mb-6 text-neutral-100" style={{ fontFamily: "var(--font-playfair)" }}>The Mathematics</h2>
          ...
          <section>
            <p className="font-mono text-[#B8963E] text-sm mb-4">IV.</p>
            <h2 className="text-2xl font-bold mb-6 text-neutral-100" style={{ fontFamily: "var(--font-playfair)" }}>The Tool, and the Collaboration That Built It</h2>
          ...
          <section>
            <p className="font-mono text-[#B8963E] text-sm mb-4">V.</p>
            <h2 className="text-2xl font-bold mb-6 text-neutral-100" style={{ fontFamily: "var(--font-playfair)" }}>What Happened When We Got It Wrong</h2>
            
            <blockquote className="border-l-4 border-[#B8963E] pl-6 py-2 my-8 text-xl italic text-neutral-400 bg-neutral-900/30 rounded-r-lg">
          ...
          <section>
            <p className="font-mono text-[#B8963E] text-sm mb-4">VI.</p>
            <h2 className="text-2xl font-bold mb-6 text-neutral-100" style={{ fontFamily: "var(--font-playfair)" }}>The Implementation</h2>
          ...
          <section>
            <p className="font-mono text-[#B8963E] text-sm mb-4">VII.</p>
            <h2 className="text-2xl font-bold mb-6 text-neutral-100" style={{ fontFamily: "var(--font-playfair)" }}>Io</h2>
          ...
          <section>
            <p className="font-mono text-[#B8963E] text-sm mb-4">VIII.</p>
            <h2 className="text-2xl font-bold mb-6 text-neutral-100" style={{ fontFamily: "var(--font-playfair)" }}>Standing on the Shoulders of the Algorithm</h2>
          ...
          <section>
            <p className="font-mono text-[#B8963E] text-sm mb-4">IX.</p>
            <h2 className="text-2xl font-bold mb-6 text-neutral-100" style={{ fontFamily: "var(--font-playfair)" }}>What Remains</h2>
          ...
          <section>
            <p className="font-mono text-[#B8963E] text-sm mb-4">X.</p>
            <h2 className="text-2xl font-bold mb-6 text-neutral-100" style={{ fontFamily: "var(--font-playfair)" }}>A Note on This Paper</h2>
